            ...
            foreach (var bg in slide.Descendants<PresentationML.BackgroundProperties>())
            {
                ...
                switch (bg_type.XmlQualifiedName.Name)
                {
                    ...
                    case "solidFill":
                        ...
                        ShapeObject solidObject = new ShapeObject(simpleSceneObject, ShapeObject.shape_type.Rectangle);
                    ...
                    case "gradFill":
                        ...
                        ShapeObject gradientObject = new ShapeObject(simpleSceneObject, ShapeObject.shape_type.Rectangle);
            ...
            foreach (PresentationML.Shape sp in spTree.Descendants<PresentationML.Shape>())
            {
                ...
                if (sp.ShapeProperties != null)
                {
                    if(sp.ShapeProperties.HasChildren)
                    {
                        ...
                        if (writeShape)
                        {
                            Console.WriteLine(shapeObject.FillAlpha);
